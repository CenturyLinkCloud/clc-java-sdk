...
import com.centurylink.cloud.sdk.base.services.CastMixin;
import com.centurylink.cloud.sdk.base.services.filter.evaluation.FilterEvaluation;
...
public interface Filter<T extends Filter<T>> extends CastMixin, FilterEvaluation<T> {
     ...
     * @return {@link com.centurylink.cloud.sdk.base.services.filter.Filter}
