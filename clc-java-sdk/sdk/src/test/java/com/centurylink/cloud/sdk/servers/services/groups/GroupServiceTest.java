...
public class GroupServiceTest extends AbstractServersSdkTest {
    ...
    public void testFindGroupsByDataCenter() {
        List<GroupMetadata> groups = groupService.findByDataCenter(com.centurylink.cloud.sdk.commons.services.domain.datacenters.refs.DataCenter.DE_FRANKFURT);
    ...
    public void testCreateGroup() {
        ...
        GroupByIdRef newGroup = groupService.create(new GroupConfig()
            .parentGroup(Group.refByName()
                    .dataCenter(com.centurylink.cloud.sdk.commons.services.domain.datacenters.refs.DataCenter.DE_FRANKFURT)
